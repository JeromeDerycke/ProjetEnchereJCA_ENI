...
<body>
	...
	<div class="container">
		...
		<form action="ServletAccueil">
			<button class="btn btn-primary  me-5" hidden="hidden"type="submit" name="accueil"
		...
		<form action="ServletAccueil">
			<button class="btn btn-primary  me-5" type="submit" name="accueil"
				value="accueil">Accueil</button>
		</form>
		
		<form action="ServletModifierProfil">
			<button class="btn btn-primary  me-5" type="submit" name="modifier"
				value="valider">Modifier</button>
		</form></div></div>
