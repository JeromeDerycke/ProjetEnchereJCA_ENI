    ...
    <div class="px-3 py-2 border-bottom mb-3">
      <div class="container d-flex flex-wrap justify-content-center">
        ...
        <div class=" d-flex no-wrap text-end">
          ...
          <form action="ServletConnexion"> <button  type="submit" class="btn btn-light text-dark me-3">Connexion</button> </form>
          <form action="ServletAjoutUtilisateur"> <button  type="submit" class="btn btn-primary me-3">S'inscrire</button> </form>
       
           <button type="button" class="btn btn-primary position-relative"> Profil
