		...
		<div class="container d-flex flex-wrap justify-content-center">
			...
			<div class="row text-end">
				<form action="ServletConnexion">
					<button type="submit" name="bt" value="connexion"
						class="btn btn-light text-dark me-2">Se connecter</button>
				</form>
				<form action="ServletAjoutUtilisateur">
					<button type="submit" name="bt" value="inscription"
...
<div class="container">
	<footer class="py-3 my-4">
		<ul class="nav justify-content-center border-bottom pb-3 mb-3">
			...
			<li class="nav-item"><a href="#"
				class="nav-link px-2 text-muted">Qui nous sommes</a></li>
		</ul>
